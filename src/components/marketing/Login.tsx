  ...
  return (
    <div className="relative z-10 w-full max-w-md px-margin-mobile md:px-0 animate-fade-in">
      <div className="text-center mb-10 flex flex-col items-center">
        ...
        <p className="font-body-md text-body-md text-on-surface-variant mt-2">Log in to access your dashboard.</p>
      </div>
      <div className="glass-card rounded-xl p-8 relative">
        ...
        <div className="mt-8 relative z-10 text-center">
          <p className="font-body-md text-body-md text-on-surface-variant">
            ...
            <Link className="font-label-md text-label-md text-primary hover:text-primary-fixed transition-colors ml-1 font-bold" href="/signup">Sign up</Link>
          </p>
        </div>
      </div>
    </div>
